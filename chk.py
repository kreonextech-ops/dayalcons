...
req = urllib.request.Request('https://gdzligxryodasaxnhdco.supabase.co/rest/v1/employees?select=id,name,role,designation', headers=HEADERS)
data=json.loads(urllib.request.urlopen(req).read().decode('utf-8'))
for d in data: print(f"{d['name']} | Role: {d['role']} | Designation: {d['designation']}")
