        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            <div className="flex items-center gap-3">
               <h1 className="text-[28px] font-bold text-[#0F172A]">{serviceCase.title}</h1>
               <span className="bg-gray-100 text-[#475569] px-3 py-1 rounded-md text-[12px] font-bold">SRV-{serviceCase.id?.substring(0,5).toUpperCase()}</span>
            </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in">
                 ...
                 {isAdmin && (
                   <Card extra="p-6 border border-[#E2E8F0] shadow-sm">
                     ...
                     <div className="space-y-4">
                       <div className="flex justify-between items-center"><span className="text-[12px] font-medium text-[#64748B]">Service Value</span><span className="text-[14px] font-bold text-[#0F172A]">₹ {totalAmount.toLocaleString()}</span></div>
