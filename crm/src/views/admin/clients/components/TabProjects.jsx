    ...
    <div className="animate-fade-in flex flex-col gap-6">
       ...
       <div className="flex justify-between items-center bg-white p-4 rounded-2xl shadow-sm border border-[#E2E8F0]">
          <div>
             ...
             <p className="text-[13px] text-[#64748B]">Manage all services and construction projects for {clientData.name || "this client"}</p>
          </div>
       ...
       <Card extra="p-6 border border-[#E2E8F0] shadow-sm">
          <div className="flex justify-between items-center mb-4">
             <div className="flex items-center gap-2">
                ...
                <h3 className="text-[16px] font-bold text-[#0F172A]">Consultancy Services</h3>
             </div>
       ...
       <Card extra="p-6 border border-[#E2E8F0] shadow-sm">
          <div className="flex justify-between items-center mb-4">
             <div className="flex items-center gap-2">
                ...
                <h3 className="text-[16px] font-bold text-[#0F172A]">Construction Projects</h3>
             </div>
          ...
          {projects.length === 0 ? (
             <div className="p-8 text-center bg-gray-50 rounded-xl border border-dashed border-gray-200">
                <p className="text-[13px] text-[#64748B]">No active construction projects.</p>
             </div>
          ) : (
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {projects.map(proj => {
