             ...
             <table className="w-full text-left border-collapse min-w-[900px]">
               <thead className="sticky top-0 z-20 bg-[#F8FAFC] dark:bg-navy-900 shadow-sm">
                 <tr className="bg-[#F8FAFC] dark:bg-navy-900 border-b border-[#E2E8F0] dark:border-navy-700">
                   ...
                   <th className="py-4 px-4 text-[12px] font-medium text-[#64748B] dark:text-gray-400 uppercase tracking-wider">Project</th>
                     ...
                     return mapped.map(proj => (
                        ...
                        >
                           <td className="py-4 px-6">
                              <span className="bg-gray-100 dark:bg-navy-700 text-gray-700 dark:text-gray-200 px-2 py-1 rounded text-xs font-bold">PRJ-{proj.id.substring(0, 5).toUpperCase()}</span>
                           </td>
                           <td className="py-4 px-4 font-bold text-[#0F172A] dark:text-white">{proj.client?.name || "Unknown"}</td>
                           <td className="py-4 px-4 text-[#0F172A] dark:text-white font-medium">{(proj?.name || proj?.title)}</td>
                           ...
                           <td className="py-4 px-4">
                              ...
                              <span className="text-[10px] font-bold text-[#64748B] dark:text-gray-400">{proj.calcProgress || 0}%</span>
                           </td>
         ...
         <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="w-full max-w-[900px] bg-white dark:bg-navy-800 rounded-[20px] shadow-2xl flex flex-col max-h-[90vh]">
               ...
               <div className="flex justify-between items-center p-6 border-b border-[#E2E8F0] dark:border-navy-700">
                  <div>
                    <h2 className="text-[20px] font-bold text-[#0F172A] dark:text-white">Create New Project</h2>
                    <p className="text-[13px] text-[#64748B] dark:text-gray-400">Step {modalStep} of 3: {modalStep === 1 ? 'Client Information' : modalStep === 2 ? 'Project Requirements' : 'Financials'}</p>
                  </div>
                             ...
                             return (
                               ...
                               >
                                 <div className="flex justify-between items-start mb-2">
                                   <div className={`p-2 rounded-lg ${checked ? 'bg-[#2563EB] text-white' : 'bg-gray-100 dark:bg-navy-700 text-[#64748B] dark:text-gray-400'}`}>{proj.icon}</div>
                                   {checked && <MdCheckCircle className="text-[#2563EB] text-xl" />}
                                 </div>
                                 <h4 className={`text-sm font-bold mt-2 ${checked ? 'text-[#0F172A] dark:text-white' : 'text-[#475569] dark:text-gray-200 dark:text-white'}`}>{proj.id}</h4>
                               </div>
                             );
                          })}
                        </div>
                        ...
                        <div className="space-y-5">
                           <div>
                              ...
                              <div className="relative">
                                 ...
                                 <input type="number" value={newCase.projectCharge} onChange={e => setNewCase({...newCase, projectCharge: e.target.value})} className="w-full h-11 pl-8 pr-3 rounded-[10px] border border-[#E2E8F0] dark:border-navy-700 text-[14px] outline-none focus:border-[#2563EB]" placeholder="0.00" />
                              </div>
                           </div>
                           <div>
