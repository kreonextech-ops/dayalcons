  ...
  return (
    ...
    >
      {cards.map((card, index) => (
        <Link href="/services" key={index} className={`block ${card.yOffset}`}>
          <motion.div 
            variants={cardVariants}
            className="group relative rounded-[2rem] overflow-hidden aspect-[4/5] md:aspect-[3/4] cursor-pointer shadow-[0_20px_40px_rgba(7,26,47,0.08)] h-full"
          >
