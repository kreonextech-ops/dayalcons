          ...
          <motion.div variants={columnVariant} className="flex flex-col lg:col-span-4 lg:pr-8">
            <motion.div variants={logoVariant} className="mb-6 flex items-center gap-4">
              ...
              <div className="flex flex-col mt-1">
                ...
                <span className="text-[16px] md:text-[18px] text-white/90 leading-tight mt-1 text-center" style={{ fontFamily: "'Monotype Corsiva', 'Apple Chancery', cursive" }}>
                  Born To Build
                </span>
              </div>
            </motion.div>
            ...
            >
              {/* Facebook */}
              <motion.a href="https://www.facebook.com/dayalconstructionssiliguri/" target="_blank" rel="noopener noreferrer" variants={fadeVariant} className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/60 transition-all duration-300 hover:border-[#1EA7FF] hover:text-[#1EA7FF] hover:-translate-y-1 hover:shadow-[0_4px_12px_rgba(30,167,255,0.3)] group bg-[#021524]/50">
              ...
              {/* Instagram */}
              <motion.a href="https://www.instagram.com/dayal.constructions.official/" target="_blank" rel="noopener noreferrer" variants={fadeVariant} className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/60 transition-all duration-300 hover:border-[#1EA7FF] hover:text-[#1EA7FF] hover:-translate-y-1 hover:shadow-[0_4px_12px_rgba(30,167,255,0.3)] group bg-[#021524]/50">
                <svg className="w-4 h-4 fill-current opacity-70 group-hover:opacity-100 transition-opacity" viewBox="0 0 24 24">
